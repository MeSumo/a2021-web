                ...
                <div id="house">
                    ...
                    <?php
                        foreach($data["result"] as $lights){
                            if($lights[1] === 1){
                                ?>
                                    <img src="img/light-on.png" id=<?= $lights[0] ?>>
                                <?php
                            }
                            else{
                                ?>
                                    <img src="img/light-off.png" id=<?= $lights[0] ?>>
                                <?php
                            }
                        }
                    ?>
                        ...
                        <div class="steps-section">
                            ...
                            <ol>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>Hôte : webmysql.notes-de-cours.com:13306 (et modifier <i>pgsql</i> pour <i>mysql</i> dans <i>new PDO()</i>)</li>
